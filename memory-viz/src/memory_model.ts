...
export class MemoryModel {
    ...
    attachInteractivity(svgElement: SVGSVGElement): void {
        const idToObjectMap = buildIdToObjectMap(
            svgElement,
            MEMORY_VIZ_OBJECT_ID_ATTR
        );
 ...
 * object(s) representing it, by reading the attr attribute off each object's
 * <g> tag within root.
 * NOTE: this function's source is also injected into the script
 * generated by setInteractivityScript()
 *
 * @param root - the SVG element or Document to search for tagged object <g>s
