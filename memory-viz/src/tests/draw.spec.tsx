...
describe("draw function", () => {
    test.each([
        ...
        {
            test: "renders a set",
            input: [{ type: "set", id: 32, value: [10, 11, 12] }],
        },
        {
        ...
        },
        {
            ...
            input: [{ type: "set", id: 32, value: [null, 1, 2] }],
        },
        {
        ...
        },
        {
            ...
            input: [{ type: "list", id: 32, value: [10, 11, 12] }],
        },
        {
        ...
        },
        {
            ...
            input: [{ type: "list", id: 32, value: [null, 1, 2] }],
        },
        {
        ...
        },
        {
            ...
            input: [{ type: "tuple", id: 32, value: [10, 11, 12] }],
        },
        {
        ...
        },
        {
            ...
            input: [{ type: "tuple", id: 32, value: [null, 1, 2] }],
        },
        {
            test: "renders a dict",
            input: [{ type: "dict", id: 10, value: { x: 81, y: 100, z: 121 } }],
        },
        {
        ...
        },
        {
            ...
            input: [
                { type: "dict", id: 10, value: { "": 100, another_key: 200 } },
            ],
        },
        {
            test: "renders dict with space key without 'id' prefix",
            input: [
                { type: "dict", id: 2, value: { " ": 300, another_key: 400 } },
            ],
        },
        {
            ...
            input: [
                {
                    type: "dict",
                    id: 3,
                    value: { "": null, " ": null, key_with_null: null },
                },
            ],
        },
        {
        ...
        },
        {
            ...
            input: [
                ...
                { type: "str", id: 42, value: "hide!", style: ["hide"] },
            ],
        },
        {
            ...
            input: [
                ...
                { type: "str", id: 42, value: "hide id!", style: ["hide_id"] },
            ],
        },
        {
        ...
        },
        {
            ...
            input: [
                ...
                { type: "str", id: 42, value: "fade!", style: ["fade"] },
            ],
        },
        {
        ...
        },
        {
            ...
            input: [
                ...
                { type: "str", id: 42, value: "fade id!", style: ["fade_id"] },
            ],
        },
        {
        ...
        },
        {
            ...
            input: [{ type: "frozenset", id: 32, value: [10, 11, 12] }],
        },
        {
        ...
        },
        {
            ...
            input: [{ type: "frozenset", id: 32, value: [null, 1, 2] }],
        },
        {
    ...
    test.each([
        {
            ...
            expected_substrings: [
                ...
                'Object id19 of type str with value "Title test"',
                "Object id13 of type int with value 7",
            ],
        },
        {
            ...
            expected_substrings: [
                ...
                "Object id10 of type int with value 42",
                'Object id20 of type str with value "test"',
                "List id30 with elements id10, id20",
                "Tuple id40 with elements id10, id20, null",
                "Dict id50 with entries id10: id20, blank key: id30",
                "Set id60 with elements id10, id20, null",
                "Frozenset id70 with elements id10, id20",
                "Class fruit with attributes name, color",
            ],
        },
        {
        ...
        {
            test: "generates title with number of elements for objects with over 10 elements",
            input: [
                {
                    type: "list",
                    id: 10,
                    value: Array.from({ length: 11 }, () => 0),
                },
                {
                    type: "set",
                    id: 20,
            ...
            expected_substrings: [
                "<title>",
                "Python memory model diagram showing objects",
                "List id10 with 11 elements",
                "Set id20 with 11 elements",
                "Dict id30 with 11 entries",
                "Class person with 11 attributes",
            ],
        },
