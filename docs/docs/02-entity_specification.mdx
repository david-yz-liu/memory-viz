...
<details>
    ...
    ![Example List with
    Indices](images/entity_specification/list_with_indices.svg)
</details>
<details>
...
<details>
    ...
    ![Example Main Stack
    Frame](images/entity_specification/stack_frame_main.svg)
</details>
<details>
    <summary>**Function stack frame with blank boxes**</summary>
    <CodeBlock language="json">{ExampleFunctionStack}</CodeBlock>
    ![Example Function Stack
    Frame](images/entity_specification/stack_frame_function.svg)
</details>
