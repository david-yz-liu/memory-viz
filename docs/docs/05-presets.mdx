...
<ThemedImage
    alt="highlight demo"
    sources={{
        light: useBaseUrl("images/presets_md/highlight_light.svg"),
        dark: useBaseUrl("images/presets_md/highlight_dark.svg"),
    }}
/>
...
<ThemedImage
    alt="hide demo"
    sources={{
        light: useBaseUrl("images/presets_md/hide_light.svg"),
        dark: useBaseUrl("images/presets_md/hide_dark.svg"),
    }}
/>
...
<ThemedImage
    alt="hide-id demo"
    sources={{
        light: useBaseUrl("images/presets_md/hide_id_light.svg"),
        dark: useBaseUrl("images/presets_md/hide_id_dark.svg"),
    }}
/>
...
<ThemedImage
    alt="hide-id demo"
    sources={{
        light: useBaseUrl("images/presets_md/hide_type_light.svg"),
        dark: useBaseUrl("images/presets_md/hide_type_dark.svg"),
    }}
/>
...
<ThemedImage
    alt="fade demo"
    sources={{
        light: useBaseUrl("images/presets_md/fade_light.svg"),
        dark: useBaseUrl("images/presets_md/fade_dark.svg"),
    }}
/>
...
<ThemedImage
    alt="fade-type demo"
    sources={{
        light: useBaseUrl("images/presets_md/fade_type_light.svg"),
        dark: useBaseUrl("images/presets_md/fade_type_dark.svg"),
    }}
/>
...
<ThemedImage
    alt="combo demo"
    sources={{
        light: useBaseUrl("images/presets_md/combo_light.svg"),
        dark: useBaseUrl("images/presets_md/combo_dark.svg"),
    }}
/>
## Implementation Note
